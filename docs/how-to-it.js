...
<ib-div class="ib_modal_container">
  ...
  <ib-div class="ib_p">
    <ib-div class="ib_ul">
      ...
      <ib-div class="ib_li">
        &#9679; &nbsp; Redisegnalo con un altro stile, usando semplici HTML &amp;technologie CSS.
      </ib-div>
      <ib-div class="ib_li">
  ...
  <ib-div class="ib_p">
    Clicca <ib-span class="ib_b">&quot;Salva l'attuale State&quot;</ib-span> bottone e segui le istruzioni sullo schermo.
  </ib-div>
  ...
  <ib-div class="ib_p">
    Salvando la fattura in PDF si può fare usando qualcosa che si chiama PDF Print Driver. Questo è anche conosciuto come stampare in PDF perchè il risultato del browser è mandato in un archivio invece in un stampante. Questa funzionalità è creata in alcuni browser (come Google Chrome), mentre in altri (come Firefox o Internet Explorer) devi installare PDF stampante manualmente. Un buono e gratuito PDF stampante è <ib-span class="ib_a" onclick="window.open('http://www.bullzip.com', '_blank')">Bullzip</ib-span>. Se già hai installato un PDF stampante, <ib-span class="ib_b">clicca &quot;Print Invoice&quot;,  &quot;Save as PDF&quot; e clicca Salva</ib-span>.
  </ib-div>

  <ib-div class="ib_p">
    Per salvare la fattura online, devi prima creare un Invoicebus account. Puoi fare questo con un semplice cliccare &quot;Save Invoice Online&quot; bottone. Poi sarai portato ad una pagina sicura dove puoi completare la tua registrazione e salvare la fattura. Per favore, nota che una fattura online è molto più potente che una statica fattura PDF. Per esempio, una fattura online può essere modificata on-the-fly, inviata per email, rintracciata e pagata direttamente con Credit card, PayPal o Bitcoin. Ecco un <ib-span class="ib_a" onclick="window.open('https://invoicebus.com/demoinvoice/', '_blank')">esempio</ib-span>.
  </ib-div>
