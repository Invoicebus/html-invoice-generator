...
<ib-div class="ib_modal_container">
    ...
    <ib-div class="ib_ul">
      <ib-div class="ib_li">
        ...
        <ib-div class="ib_ul">
          ...
          <ib-div class="ib_li">
            &#9675; &nbsp; Save your default company data for future re-use.
          </ib-div>
        </ib-div>
      </ib-div>
      <ib-div class="ib_li">
  ...
  <ib-div class="ib_p">
    There are two ways to save the invoice:
    <ib-div class="ib_ul">
      <ib-div class="ib_li">
        - &nbsp; Save it to PDF using PDF printer.
      </ib-div>
      <ib-div class="ib_li">
        - &nbsp; Save it online to our online invoicing system Invoicebus.
      </ib-div>
    </ib-div>
  </ib-div>
  ...
  <ib-div class="ib_p">
    Maintaining this script takes a lot of time and effort to keep it bug free and up to date. All we're asking is a little favor – discrete fine print of our invoicing service at the bottom of the printed document. It would mean the world to us if you leave it there. Thanks!
  </ib-div>
