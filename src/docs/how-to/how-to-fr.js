...
<ib-div class="ib_modal_container">
  ...
  <ib-div class="ib_p">
    <ib-div class="ib_ul">
      <ib-div class="ib_li">
        &#9679; &nbsp; Ecrire des factures qui ont l'air professionnel dans des secondes.
        <ib-div class="ib_ul">
          <ib-div class="ib_li">
            &#9675; &nbsp; Utiliser n'importe quelle langue ou monnaie.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp; Ajouter votre propre logo avec une simple action de tirer et laisser tomber.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp; Facilement ajouter, supprimer et réorganiser des lignes d'articles.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp;Ajouter des taxes et des réductions.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp; Configurer une visibilité de la colonne d'articles.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp; Auto-calculer des totals partiels,des totals,des taxes et des réductions.
          </ib-div>
          <ib-div class="ib_li">
            &#9675; &nbsp; Enregistre vos données d'entreprise de défaut pour un futur réemploi.
          </ib-div>
        </ib-div>
      </ib-div>
      <ib-div class="ib_li">
      ...
      <ib-div class="ib_li">
        &#9679; &nbsp;Enregistrer sous un format PDF ou enregistrer en ligne.
      </ib-div>
    </ib-div>
  </ib-div>
  ...
  <ib-div class="ib_p">
    Il y a deux façons de sauvegarder la facture:
    <ib-div class="ib_ul">
      <ib-div class="ib_li">
        - &nbsp; Enregistre sous PDF en utilisant une imprimante PDF.
      </ib-div>
      <ib-div class="ib_li">
        - &nbsp; Enregistrer en ligne en utilisant notre système de facturation Invoicebus.
      </ib-div>
    </ib-div>
  </ib-div>
  ...
  <ib-div class="ib_p">
    Le template est fait avec une simplicité pour qu'il puisse être facilement personnalisé avec vos propres marques et couleurs. Quand même, une connaissance basique de in HTML et CSS est requise. 
  </ib-div>
  ...
  <ib-div class="ib_p">
    <ib-span class="ib_b">Note:</ib-span> Le template est complètement séparé de sa logique, alors vous ne devez pas vous occuper avec une programmation ou avec JavaScript code.
  </ib-div>
  ...
  <ib-div class="ib_p">
    Généralement, nous vous encourageons à continuer avec l'utilisation du script à distance, car toute mise à jour récente met à jour immédiatement la réflexion dans le template que vous utilisez.
  </ib-div>
  ...
  <ib-div class="ib_p">
   Y-a-t-il quelque chose que nous pouvons faire pour améliorer ce template pour vous? De bonnes choses / de mauvaises choses? N'hésitez pas à trouvez un sujet approprié sur notre <ib-span class="ib_a" onclick="window.open('https://groups.google.com/d/forum/html-invoice-generator', '_blank')">forum de soutien</ib-span> et frappez nous – nous lisons et nous répondons à chaque question.
  </ib-div>
</ib-div>
*/}
